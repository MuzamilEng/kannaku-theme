    ...
    return (
      <div className="header">
        <div className="header-left">
          <Link href="/">
            <a className="logo">
              <Image src={LogoImg} alt="Logo" width="175" height="45" />
            </a>
          </Link>
          <Link href="/">
            <a className="logo logo-small">
              <Image src={LogoSmallImg} alt="Logo" width="30" height="30" />
            </a>
          </Link>
        </div>
        ...
        <ul className="nav user-menu">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              <a href="#" className="dropdown-item">
                <div className="img-div">
                  <Image src={UsFlag} alt="" height="16" width="16" />
                </div>{" "}
                English
              </a>
              <a href="#" className="dropdown-item">
                <div className="img-div">
                  <Image src={FrFlag} alt="" height="16" width="16" />
                </div>{" "}
                French
              </a>
              <a href="#" className="dropdown-item">
                <div className="img-div">
                  <Image src={EsFlag} alt="" height="16" width="16" />
                </div>{" "}
                Spanish
              </a>
              <a href="#" className="dropdown-item">
                <div className="img-div">
                  <Image src={DeFlag} alt="" height="16" width="16" />
                </div>{" "}
                German
              </a>
            </div>
          ...
          <li className="nav-item dropdown mt-2 pt-1">
            <a
              href="#"
            ...
            <div className="dropdown-menu">
              <Link href="/profile">
                <a className="dropdown-item">
                  <FeatherIcon icon="user" className="mr-1" /> Profile
                </a>
              </Link>
              <Link href="/settings">
                <a className="dropdown-item">
